...
const Card = ({ img, status, title, price, id }) => {
  ...
  return (
    <Link to={`/product/${id}`}>
      <div className={`${isDark ? "bg-[#2a2f38] shadow-lg shadow-black/30" : "bg-[#ffffff]"} w-[100%]  items-center rounded-b-[10px] h-[100%]`}>
        ...
        <div className="flex justify-between text-[#1565c0] pb-8 mr-4 ml-4 font-extrabold font-[iranyekanwebregular]">
